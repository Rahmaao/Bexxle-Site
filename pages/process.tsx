      ...
      <div className="w-[95%] md:w-[80%] h-full flex flex-col justify-center lg:justify-start items-center md:items-start">
        ...
        >
          <div className="relative w-full h-full">
            <div className="absolute w-56 h-44 top-[385px] left-[200px] bg-transparent flex flex-col select-none group">
            ...
            <div className="absolute w-60 h-44 top-[230px] left-[620px] bg-transparent flex flex-col select-none group">
              <div className="w-full h-[65%] flex">
                <div className="w-[70%] h-full flex flex-col">
                  <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
                  <div className="w-full h-10 flex items-end">
            ...
            <div className="absolute w-60 h-44 top-[-15px] left-[980px] bg-transparent flex flex-col select-none group">
              <div className="w-full h-[65%] flex">
                <div className="w-[70%] h-full flex flex-col">
                  <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
                  <div className="w-full h-10 flex items-end">
...
//           style={{ backgroundImage: "url('/wave.svg')" }}
//         >
//           <div className="w-56 h-44 absolute top-[350px] left-[200px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
...
//           <div className="w-60 h-44 absolute top-[220px] left-[620px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
...
//           <div className="w-60 h-44 absolute top-[15px] left-[850px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
