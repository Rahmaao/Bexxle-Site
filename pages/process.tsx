  ...
  return (
    <section className="w-full h-[100vh] md:h-[90vh] lg:h-[105vh] xl:h-[135vh] flex justify-center items-center lg:mb-16 process-section">
      <div className="w-[95%] md:w-[80%] h-full flex flex-col justify-center lg:justify-start items-center md:items-start">
        ...
        <div
          className="hidden xl:block relative w-full h-[65%] md:h-[75%] lg:h-[65%] bg-red-700 bg-contain bg-top bg-no-repeat"
        ...
        >
          ...
          <div className="w-60 h-44 absolute top-[-15px] left-[780px] bg-transparent flex flex-col select-none group">
            <div className="w-full h-[65%] flex">
              <div className="w-[70%] h-full flex flex-col">
                <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
                <div className="w-full h-10 flex items-end">
...
// export const Process = () => {
//   return (
//     <section className="w-full h-[100vh] md:h-[90vh] lg:h-[105vh] xl:h-[135vh] flex justify-center items-center lg:mb-16 xl:mb-28 process-section">
//       <div className="w-[95%] md:w-[80%] xl:w-full h-full flex flex-col justify-center lg:justify-start items-center md:items-start xl:items-center">
//         <div className="w-[90%] md:w-full lg:w-[55%] xl:w-[80%] md:h-[25%]">
...
//         </div>
//         <div
//           className="hidden xl:block relative w-full h-[65%] md:h-[75%] lg:h-[65%] xl:h-[75%] bg-contain bg-no-repeat"
//           style={{
//             backgroundImage: "url('/wave.svg')",
//             backgroundSize: "1245px 1000px",
//             backgroundPosition: "center",
//           }}
//         >
//           <div className="w-56 h-44 absolute top-[500px] left-[345px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
...
//               </div>
//               <div className="w-[25%] h-full flex justify-center items-center">
//                 <p className="numero text-[140px] text-[#707070] opacity-15">
//                   1
//                 </p>
//               </div>
//             </div>
...
//           <div className="w-60 h-44 absolute top-[345px] left-[800px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
...
//           <div className="w-60 h-44 absolute top-[70px] left-[1140px] bg-transparent flex flex-col select-none group">
//             <div className="w-full h-[65%] flex">
//               <div className="w-[70%] h-full flex flex-col">
//                 <div className="w-16 h-16 bg-process hover:bg-process2 bg-contain bg-center bg-no-repeat transition-all duration-500 group-hover:bg-process2"></div>
//                 <div className="w-full h-10 flex items-end">
